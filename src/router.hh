...
struct Rule {
	...
	explicit Rule(uint32_t route_prefix, uint8_t prefix_length, std::optional<Address> next_hop, size_t interface_num)
...
public:
  ...
  int countPrefixLength(uint32_t ip, Rule& rule);
};
